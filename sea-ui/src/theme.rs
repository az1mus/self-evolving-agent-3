...
/// 绿色：`+` 添加行 #6EB56A
pub const DIFF_ADD: Color = Color::Rgb(110, 181, 106);

/// 红色：`-` 删除行 #CC463E
pub const DIFF_REMOVE: Color = Color::Rgb(204, 70, 62);

/// 青色：`@@` 上下文标记行
pub const DIFF_HUNK: Color = Color::Rgb(87, 143, 169);
